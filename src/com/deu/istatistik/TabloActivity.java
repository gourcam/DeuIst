	...
	public void btn_z_Click(View vi) {
		try {
			...
			if (x < 3.5) {
				...
				//Eski Hali başlangıç
				//tuphane.getAlertDialog(this, "Sonu� : ",
				//Double.toString(sonuc + y1));
				//değiştirilme nedeni: İnterpolasyon hesaplaması yapıtığı için çok küçük sapmalar olabiliyor.
				//Örn : 1,657 için, 0..1000000000000002 gibi bir değer geliyor. 
				//Bu nedenle sayının uzunluğunun kontrol edilip ona göre yazması gerekiyor. Düzeldilmiş hali yukarda.
				//Eski hali bitiş
